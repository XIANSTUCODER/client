...
choose_phone = "真机redmi"  #"真机huawei"/"pad"/"真机redmi"
...
if __name__=="__main__":
    ...
    keyinput_action_data = {
        ...
        'data': {
            ...
            'input_text': '中文/English'  # 要输入的文本内容
            # 'text': 'CAT'  # 要输入的文本内容
        }
    }  
    ...
    image_path = 'screenshot/screenshot_test.png'
